...
def build_apple_amodal_dataset(image_set, args):
    root = Path(args.coco_path)
    assert root.exists(), f'provided COCO path {root} does not exist'
    mode = 'instances'
    PATHS = {
...
def build_apple_modal_dataset(image_set, args):
    root = Path(args.coco_path)
    assert root.exists(), f'provided COCO path {root} does not exist'
    mode = 'instances'
    PATHS = {
...
def build_apple_modal_synth_dataset(image_set, args):
    ...
    mode = 'instances'
    PATHS = {
        "train": (root / "train_apples", root / "annotations" / "modal" / f'{mode}_train.json'),
        "val": (root / "val_apples", root / "annotations" / "modal" / f'{mode}_val.json'),
    }
...
def build_apple_amodal_synth_dataset(image_set, args):
    root = Path(args.coco_path)
    assert root.exists(), f'provided COCO path {root} does not exist'
    mode = 'instances'
    PATHS = {
        "train": (root / "train_apples", root / "annotations" / "amodal" / f'{mode}_train.json'),
        "val": (root / "val_apples", root / "annotations" / "amodal" / f'{mode}_val.json'),
    }
