...
def plot_results(pil_img, prob, boxes, save=False, save_dir=None, img_file_name=None):
...
for img_file_name in img_file_names:
    ...
    #
    # im = Image.open('apple_images/_MG_2821_13.png')
    ...
    plot_results(im, probas[keep], bboxes_scaled, True, save_dir, img_file_name)