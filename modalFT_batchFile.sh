...
#SBATCH -o /nfs/hpc/share/browjost/detr_apple/logdirs/modalFT/modalFineTune-%a.out			  # name of output file for this submission script
#SBATCH -e /nfs/hpc/share/browjost/detr_apple/logdirs/modalFT/modalFineTune-%a.err				  # name of error file for this submission script1
#SBATCH --gres=gpu:2
